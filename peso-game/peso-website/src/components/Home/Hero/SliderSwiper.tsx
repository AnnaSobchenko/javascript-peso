  ...
  return (
    <div className="relative mx-auto">
      ...
      {data && data.items.map((item) => (           
            <SwiperSlide key={item.id.videoId} className="relative z-10 shadow-[0_12px_22px_5px_rgba(14,14,14,1)] md:shadow-[0_25px_30px_10px_rgba(14,14,14,1)] lg:md:shadow-[0_25px_30px_10px_rgba(14,14,14,1)]">
