...
import SwiperCore, { Pagination, Navigation, Keyboard, EffectCoverflow, Autoplay } from "swiper";
import "swiper/scss";
import 'swiper/scss/pagination';
import "swiper/scss/effect-coverflow";
SwiperCore.use([Pagination, Navigation, Keyboard, EffectCoverflow, Autoplay, SwiperCore.Loop]);
  ...
  return (
    <div className="relative mx-auto">
      ...
      {data && data.items.map((item) => (    
            ...
            <SwiperSlide key={item.id.videoId} className="z-10 shadow-[0_12px_22px_5px_rgba(14,14,14,1)] md:shadow-[0_25px_30px_10px_rgba(14,14,14,1)] lg:md:shadow-[0_25px_30px_10px_rgba(14,14,14,1)]">
              <iframe
