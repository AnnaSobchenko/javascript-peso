...
export const LicensePlc: FC<TextFCComponentsProps> = ({ textTr }) => {
    ...
    <div className="w-full px-6 mt-20 mb-48 layout">
      ...
      <ul className="">
        <li className="flex mb-2.5 py-4 px-11 bg-accent-background items-center">
          ...
          <p className={`${textAccentFont} text-lg`}>{textTr.licenseFirst}</p>
        </li>
        <li className="flex mb-2.5 py-4 px-11 bg-accent-background items-center">
          <div className=" mr-4">
            <ThreeVertDots />
          </div>
          <p className={`${textAccentFont} text-lg`}>{textTr.licenseSecond}</p>
        </li>
        <li className="flex mb-2.5 py-4 px-11 bg-accent-background items-center">
          <div className=" mr-4">
            <ThreeVertDots />
          </div>
          <p className={`${textAccentFont} text-lg`}>{textTr.licenseThird}</p>
        </li>
        <li className="flex py-4 px-11 pb-6 bg-accent-background items-center">
          <div className=" mr-4">
            <ThreeVertDots />
          </div>
          <p className={`${textAccentFont} text-lg`}>{textTr.licenseFourth}</p>
        </li>
      </ul>
